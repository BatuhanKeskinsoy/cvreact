...
function Footer() {
  return (
    <footer className='dark:bg-customSecondary-900 bg-gray-200 md:pb-0 pb-14'>
      ...
      <div className="flex md:hidden flex-row items-end fixed bottom-0 left-0 w-full z-10 dark:bg-customSecondary-900 bg-white shadow-customLg ">
        {
          LinksData.map((HeaderLink, key) => {
            return (
