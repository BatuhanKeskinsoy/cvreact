...
function ExperienceItem(props) {
    ...
    return (
        <div className='flex flex-col mx-4 flex-auto justify-center items-center mb-5'>
            <Tilt perspective={1000} className='parallax-effect-img cursor-pointer flex flex-col'>
                <div className="xl:h-32 xl:w-32 lg:h-24 lg:w-24 h-24 w-24 absolute top-0 left-0 dark:bg-customSecondary-900 bg-gray-200 rounded-full -z-10 flex items-center justify-center"></div>
