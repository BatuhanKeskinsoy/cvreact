  ...
  return (
    <li>
      <Link to={props.link} target={'_blank'} className='flex justify-center items-center group'>
        <Icon
          className='mx-2 p-2 dark:text-gray-300 text-customSecondary-900 shadow-customSm shadow-gray-400 dark:shadow-gray-600 rounded-full text-5xl transition-all 
